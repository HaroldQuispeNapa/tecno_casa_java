...
<div class="flex-grow-1 p-4" id="main-content">
    ...
    <h1 class="page-title">Gestión de Sugerencias</h1>
...
<script type="module" src="${pageContext.request.contextPath}/js/sugerencias.js"></script>